document.addEventListener('DOMContentLoaded', function() {
  ...
  const prevLessonPath = currentLessonNumber > 1 ? `../0${currentLessonNumber - 1}/g11-${currentLessonNumber - 1}.html` : '../grade-11-main.html'; //Change g6 to g<your grade> and grade-6-main.html to grade-<your grade>-main.html
  ...
  const nextLessonPath = currentLessonNumber < totalLessons ? `../0${currentLessonNumber + 1}/g11-${currentLessonNumber + 1}.html` : '../grade-11-main.html'; //Change g6 to g<your grade> and grade-6-main.html to grade-<your grade>-main.html
