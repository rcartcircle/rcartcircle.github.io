document.addEventListener('DOMContentLoaded', function() {
  ...
  const currentLessonMatch = currentPath.match(/g6-(\d+)\.html/); //Change g6 to g<your grade>; Assuming g6-<lesson number>.html format
  ...
  const prevLessonPath = currentLessonNumber > 1 ? `../0${currentLessonNumber - 1}/g6-${currentLessonNumber - 1}.html` : '../grade-6-main.html'; //Change g6 to g<your grade> and grade-6-main.html to grade-<your grade>-main.html
  ...
  const nextLessonPath = currentLessonNumber < totalLessons ? `../0${currentLessonNumber + 1}/g6-${currentLessonNumber + 1}.html` : '../grade-6-main.html'; //Change g6 to g<your grade> and grade-6-main.html to grade-<your grade>-main.html
